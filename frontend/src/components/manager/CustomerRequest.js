  ...
  return (
    <M_Layout>
      <div className="container mx-auto py-4">
        <div className="ml-8">
          <Link to="/ShowMessage">
            <div className="bg-gray-300 w-1/4  text-white rounded py-2 ml-10 mt-4 flex">
              <div className='ml-3 '>
                <h1 className='text-blue-800 flex font-semibold mr-ml-3'><BiSolidNotification color='black' size={20} className='mt-1' />sivaganesz@customer_01<br/></h1>
              </div>
            </div></Link>
        </div>
      </div>
